    ...
    public void run(String... args) {
        ...
        try {
            ...
            if (roleRepository.count() == 0 && userRepository.count() == 0) {
                ...
                User user2 = User.builder().username("customer1@hotel.com").password(passwordEncoder.encode("1")).name("Ishita").lastName("Binwal").role(customerRole).build();
                User user3 = User.builder().username("manager1@hotel.com").password(passwordEncoder.encode("1")).name("Krishaben").lastName("Bhalani").role(hotelManagerRole).build();
                User user4 = User.builder().username("manager2@hotel.com").password(passwordEncoder.encode("1")).name("Prashil").lastName("Jatakiya").role(hotelManagerRole).build();
                ...
                Address addressIst1 = Address.builder().addressLine("Plot No - 30, Rajaram Mohan Roy Road, Off Richmond Road 560027").city("Bengaluru")
                        .country("India").build();
                Address addressIst2 = Address.builder().addressLine("41/3, Mahatma Gandhi Rd, Yellappa Garden, Yellappa Chetty Layout, Sivanchetti Gardens").city("Bengaluru")
                        .country("India").build();
                Address addressIst3 = Address.builder().addressLine("off Intermediate Ring Road, Embassy Golf Links Business Park, Challaghatta").city("Bengaluru")
                        .country("India").build();
                ...
                Hotel hotelIst1 = Hotel.builder().name("Swissotel The Bosphorus Bengaluru")
                        .address(addressIst1).hotelManager(hm1).build();
                Hotel hotelIst2 = Hotel.builder().name("Four Seasons Hotel Bengaluru")
                        .address(addressIst2).hotelManager(hm1).build();
                Hotel hotelIst3 = Hotel.builder().name("Ciragan Palace Kempinski Bengaluru")
